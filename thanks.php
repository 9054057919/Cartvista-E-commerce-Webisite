...
foreach ($itemsArray as $item) {
    $valuesArray[] = "('" . $item["u_id"] . "', '" . $item["p_id"] . "', '" . $item["shop_"] . "', '" . $item["qty"] . "', '" . $item["order_id"] . "', '" . $item["order_time"] . "', '" . $item["price"] . "', '" . $item["coupon"] . "', '" . $item["discount"] . "', '" . $item["size"] . "')";
    $discount_price=$item["discount"];
}
$valuesString = implode(", ", $valuesArray);
$insertQuery = "INSERT INTO orders (u_id, p_id,shop_id, qty, order_id,order_time,price,coupon,discount,size) VALUES $valuesString";
