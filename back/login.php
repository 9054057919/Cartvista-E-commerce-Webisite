...
<div class='onkar_div q'>
   ...
   <p style='text-align: center;'>All rights reseved ! <a href='#'>Cartvista</a></p>
</center>
</div>
<br><br>
</body>
...
echo smtp_mailer($email,'Cartvista - OTP',$otp,$mail_email,$mail_pass,$mail_host,$mail_sender);
}
