...
<body>
    ...
    <div class="owl-carousel" id="owl-carousel3">
        <div class="home_cara ">
            <div class="banner">
                <div class="pc_banner" style="background-image: url('banner/4.png');">
                    <div class="pc_overlay"></div>
                </div>
                <div class="mobile_banner" style="background-image: url('banner/4m.png');">
        ...
        <div class="home_cara ">
            <div class="banner">
                <div class="pc_banner" style="background-image: url('banner/11.webp');">
                    <div class="pc_overlay"></div>
                </div>
                <div class="mobile_banner" style="background-image: url('banner/');">
                    <div class="mobile_overlay"></div>
                </div>
                <div class="banner_texts">
        ...
        <div class="home_cara ">
            <div class="banner">
                <div class="pc_banner" style="background-image: url('banner/3.5.png');">
                    <div class="pc_overlay"></div>
                </div>
                <div class="mobile_banner" style="background-image: url('banner/4.webp');">
                    <div class="mobile_overlay"></div>
                </div>
                <div class="banner_texts">
        ...
        <div class="home_cara ">
            <div class="banner">
                <div class="pc_banner" style="background-image: url('banner/5.webp');">
                    <div class="pc_overlay"></div>
                </div>
                <div class="mobile_banner" style="background-image: url('banner/');">
                    <div class="mobile_overlay"></div>
    ...
    <section class="container">
        <div class="flex_ mobile-flex-direction align-items justify-content">
            ...
            <div class="new_cat_box">
                ...
                <div class="shop-body">
                    <h3>Accessories<br>Collection</h3><br>
            ...
            <div class="new_cat_box">
                ...
                <div class="shop-body">
                    <h3>Cameras<br>Collection</h3><br>
    ...
    <section class="container margin-top-20" style="padding:0;">
        <div class="flex_ align-items justify-content  _headings_ mobile-flex-direction">
            <h2 class="sub-head2 margin-top-20" data-item="OUR PRODUCTS">New Arrivals</h2>
            <div class="head_cat">
    ...
    <section class="container deals_of_the_day">
        <div class="flex_ align-items justify-content  _headings_ mobile-flex-direction">
            <h2 class="sub-head2 margin-top-20" data-item="Find The best">Trending Deal</h2>
            <div class="head_cat">
                                <span class="active_">ALL</span>
                <?php
                $i=0;
...
<!--
            <div class="product">
                <a href="single-product.php?id=7">
                    <div class="product_img">
                        <img src="prod/1705632700p04.png" class="transform">
                        <p class="discount">2% OFF</p><button class="btn-outline-heart">
                            <img src="assets/images/heart.svg" title="Add to Wishlist">
                        </button>
                    </div>
                </a>
                <div class="product_des">
                    <p class="product_name">Mic for recording sweet voice of India</p>
                    <div class="flex_ padding">
                        <p class="product_stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half"></i></p>
                        &nbsp;&nbsp;
                        <p class="product_rev">(0 Reviews)</p>
                    </div>
                    <div class="flex_ padding margin-bottom-20 margin-top-10 justify-align cart_and_price mobile-cart-price">
                        <div><button class="btn-outline margin-top-10 add_cart" data-pid="7">Add to Cart</button></div>
                        <p class="product_price"><span class="pr_dis">₹456</span>₹446</p>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                <a href="single-product.php?id=2">
                    <div class="product_img">
                        <img src="prod/1705564194p1-768x715.jpg" class="transform">
                        <p class="discount">12% OFF</p><button class="btn-outline-heart">
                            <img src="assets/images/heart.svg" title="Add to Wishlist">
                        </button>
                    </div>
                </a>
                <div class="product_des">
                    <p class="product_name">HP ball mouse with fast sensitivity</p>
                    <div class="flex_ padding">
                        <p class="product_stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half"></i></p>
                        &nbsp;&nbsp;
                        <p class="product_rev">(-1 Reviews)</p>
                    </div>
                    <div class="flex_ padding margin-bottom-20 margin-top-10 justify-align cart_and_price mobile-cart-price">
                        <div><button class="btn-outline margin-top-10 p_no_stock" style="color:var(--red);border:1px solid var(--red);">OUT OF STOCK</button></div>
                        <p class="product_price"><span class="pr_dis">₹650</span>₹572</p>
                    </div>
                </div>
            </div>
            ...
            <div class="product">
                <a href="single-product.php?id=10">
                    <div class="product_img">
                        <img src="prod/1705632833p5.jpg" class="transform"><button class="btn-outline-heart">
                            <img src="assets/images/heart.svg" title="Add to Wishlist">
                        </button>
                    </div>
                </a>
                <div class="product_des">
                    <p class="product_name">Hand Bag for women to carry nothing </p>
                    <div class="flex_ padding">
                        <p class="product_stars"><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star-half"></i></p>
                        &nbsp;&nbsp;
                        <p class="product_rev">(0 Reviews)</p>
                    ...
                    <div class="flex_ padding margin-bottom-20 margin-top-10 justify-align cart_and_price mobile-cart-price">
                        <div><button class="btn-outline margin-top-10 add_cart" data-pid="10">Add to Cart</button></div>
    ...
    <section class="container margin-top-20 flex_ justify-content mobile-flex-direction">
      <div class="big_deals" style="background-image: url('banner/b1.jpg');">
         <div class="flex_ flex-direction justify-content b1">
               ...
               <div>
                  <h3>Home Smart Speaker with Google Assistant</h3>
                  <p class="margin-top-20 big_price bold">$3,999</p>
      ...
      <div class="big_deals" style="background-image: url('banner/b2.jpg');">
         <div class="flex_ flex-direction justify-content b1">
               <div>
               <h2 class="red">Your Exclusive Offers.</h2>
               <p class="">Sign in to see amazing deals.</p>
               </div>
               <div>
                  <h3>Certified Wireless Charging Pad for iPhone / Android</h3>
...
if ($result->num_rows > 0) {
    ...
    <div class="container margin-top-20">
        ...
        <div class="logos_ flex_">
            <div class="flex_ align-items justify-content-center partner-logo margin-top-20">
                <img src="assets/images/dominoz.png?">
                <img src="assets/images/pizzahut.png">
                <img src="assets/images/swiggy.png?v=1">
    ...
    <section class="container margin-top-20 flex_ align-items mobile-flex-direction-reverse">
        <div class=" flex-1">
            <h2 class="sub-head margin-top-20" data-item="Who are we?">About Cartvista</h2>
            <p class="margin-top-20">
                Cartvista was born out of a shared love for online shop and a desire to make dining experiences both delightful and effortless. Our journey began in Vadodara,
            </p>
            ...
            <div class="flex_ margin-top-20 flex-direction">
                <div class="margin-top-10 flex_">
                    <a class="share_icon_div share-ig" target="blank" href="https://instagram.com/km_bittu.pandey"><i class="fab fa-instagram"></i></a>
                    <a class="share_icon_div share-tw" target="blank" href="https://twitter.com/"><i class="fab fa-twitter"></i></a>
                    <a class="share_icon_div share-yt" target="blank" href="https://youtube.com/"><i class="fab fa-youtube"></i></a>
                    <a class="share_icon_div share-wh" target="blank" href="https://wa.me/+919054057919"><i class="fab fa-whatsapp"></i></a>
                </div>
            </div>
            <br>
        ...
        <div class="flex-1 flex_ align-items justify-content-center">
            <img src="cat/2.png" class="about_image">
        </div>
    </section>
    ...
    <div class="news_letter relative margin-top-20">
        ...
        <div class="container ">
            ...
            <form class="margin-top-20 flex_  news_form">
                <input type="email" class="news__" placeholder="Enter your Email ID*" required>
    ...
    <!---
      <div style="position: fixed;bottom: 110px;right:30px;display: flex;flex-direction: column;z-index: 100000;">
         <a href="https://wa.me/+919054057919" target="blank" style="width:50px;height: 50px;border-radius: 50px;background: var(--p);color: #fff; " class="flex_ align-items justify-content-center"><i class="fab fa-whatsapp" style="color: #fff;"></i></a>
         <br>
         <a href="tel:+919054057919" style="width:50px;height: 50px;border-radius: 50px;background: var(--p);color: #fff;" class="flex_ align-items justify-content-center"><i class="fas fa-phone-alt" style="color: #fff;"></i></a>
      </div>-->
